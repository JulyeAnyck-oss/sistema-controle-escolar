...
Sistema em Python via terminal para gestão escolar, com cadastro de usuários

(professores e alunos), lançamento de notas e frequência, geração de boletins

e exportação de relatórios em arquivo de texto.
